...
export default function Home({ onNavigate }: HomeProps) {
  ...
  const filteredBooks = searchQuery.trim()
    ? sortedBooks.filter((b) => b.name.toLowerCase().includes(searchQuery.trim().toLowerCase()))
    : sortedBooks;
                ...
                <>
                  ...
                  {dropdownOpen && (
                    <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-xl border border-gray-200 shadow-lg z-50 overflow-hidden">
                      ...
                      <div className="p-2 border-b border-gray-100 bg-gray-50">
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder="搜索单词本..."
                            className="w-full pl-8 pr-8 py-1.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                      ...
                      {/* Footer count */}
                      <div className="px-3 py-2 border-t border-gray-100 bg-gray-50 text-xs text-gray-400 text-center">
                        共 {filteredBooks.length} / {wordBooks.length} 个单词本
                      </div>
                    </div>
                  )}
                </>
